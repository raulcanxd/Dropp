...
var commands = exports.commands = {
	...
	warn: function (target, room, user) {
		...
		targetUser.popup("|wide|" + "|modal|" + "|html|" + "<font color=\"#0489B1\">" +  target + "<h2><font color=\"#0489B1\"><h2>Reglas Del Servidor Dropp<h2></font></h2><b><p>Estas reglas tienen como objetivo crear un buen ambiente social dentro <br>del servidor para todos los miembros de la comunidad.Si hay incumplimiento de estas<br> reglas ya conoceran las consecuencias.<p><h2><font color=\"#0489B1\">Social:</font></h2><p>Respetar a las demas personas en el servidor, nada de comentarios groseros, ofensas racistas,<br> xenofobicas, homofobicas, etc.<ol><li>No publicar material explicito.</li><br><li>Respeto en el chat de las peleas tanto de ladder como de tour.</li><br><li>No hay restriccion de idiomas en el servidor. <br>En caso de problemas hablar con %, @, &, ~.</li><br><li>Prohibido hacer SPAM o flood, armar flamewars o hacerse el troll.</li><br><li>Tambien se prohibe publicar enlaces de otras paginas web.<br> Ya sean servidores o redes sociales. Se permite, no obstante, <br>publicar imagenes y videos.</li><br><li>Prohibido el uso excesivo de CAPS/MAYUS. De vez en cuando seran aceptables, <br>pero su abuso es sancionable.</li><br><li>No hagas el trabajo de un auth si no te corresponde.</li><br><li>No pidas ser $, +, ⊕, %, @, & o ~. Ya hay un Staff seleccionado.</li><br><li>No hagas flood (4 o mas lineas de mensaje que podrian caber en 1).</li><br><li>No abusar de los comandos como __/me__ entre otros,<br> el abuso del comando sera considerado como SPAM.</li></ol><br><h2><font color=\"#0489B1\">Nicknames:</font></h2><ol><li>Prohibido poner nombres insultantes.</li><br><li>Los nombres no deben tener excesos de Mayus.</li></ol><br><h2><font color=\"#0489B1\">Avatares Personalizados</font></h2><ol><li>Queda prohibido pedir avatares personalizados a los administradores</li><br><li>Para tener un avatar personalizado se realizaran concursos <br>o torneos especiales para dar como premio.</li></ol><h2><font color=\"#0489B1\">Salas de chat</font></h2><p>Las salas de chat solo seran hechas para los clanes, ligas, por adquisicion en la tienda <br<del servidor y algunos casos especiales.</b></p>" );
		this.add('|unlink|' + this.getLastIdOf(targetUser));
	},
	...
	unmutehelp: ["/daymute [username] - Silences a user for 24 hours. Requires: % @ # & ~"],
