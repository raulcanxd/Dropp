...
tienda: 'shop',
    shop: function (target, room, user) {
        ...
        this.sendReplyBox(
             <table width="100%" bgcolor="black"><tr><td><h1><font color="black"><marquee bgcolor="green" <marquee bgcolor="green" <h3><blink>eternity shop</font></h1><div style="background:#abf6b6;"><table><tr><td><center><font color=#24ff0f><b><p> Bienvenido a la Tienda del Servidor </b></p></font><table cellspacing="1" cellpadding="3" target="_blank"><tbody>' +
